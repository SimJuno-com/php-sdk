...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2FSimJuno-com%2Fphp-sdk)
[![php shield](https://img.shields.io/badge/php-packagist-pink)](https://packagist.org/packages/simjuno/simjuno)

The Simjuno PHP library provides convenient access to the Simjuno APIs from PHP.
...
```sh
composer require simjuno/simjuno
```
...
try {
    $response = $client->esim->orderEsim(...);
} catch (SimjunoApiException $e) {
...
$client = new SimjunoClient(options: [
    'client' => $customClient
]);
