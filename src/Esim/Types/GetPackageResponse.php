...
class GetPackageResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var array<GetPackageResponseLocationNetworkListItem> $locationNetworkList
     */
    #[JsonProperty('locationNetworkList'), ArrayType([GetPackageResponseLocationNetworkListItem::class])]
    ...
    /**
     * @var ?array<GetPackageResponseSubLocationListItem> $subLocationList
     */
    #[JsonProperty('subLocationList'), ArrayType([GetPackageResponseSubLocationListItem::class])]
     ...
     *   activeType: float,
     *   speed: string,
     *   locationNetworkList: array<GetPackageResponseLocationNetworkListItem>,
     *   ipExport: string,
     *   supportTopUpType: float,
     *   fupPolicy?: ?string,
     *   subLocationList?: ?array<GetPackageResponseSubLocationListItem>,
     * } $values
     */
